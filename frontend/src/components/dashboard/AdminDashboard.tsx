...
import { Wallet, Users, TrendingUp, AlertCircle, FileText, DollarSign, Activity, UserMinus } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="glass rounded-xl p-6 border border-border">
                    <h3 className="text-lg font-semibold text-foreground mb-4">Branch Performance</h3>
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="text-muted-foreground border-b border-border">
                                    <th className="text-left pb-2 font-medium">Branch</th>
                                    <th className="text-right pb-2 font-medium">Loans</th>
                                    <th className="text-right pb-2 font-medium">Portfolio</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-border">
                                {data.branch_performance?.map((branch, idx) => (
                                    <tr key={idx} className="text-foreground">
                                        <td className="py-3 font-medium">{branch.name}</td>
                                        <td className="py-3 text-right">{branch.active_loans}</td>
                                        <td className="py-3 text-right">{formatCurrency(branch.portfolio_value)}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
