...
class SavingsProduct(models.Model):
    ...
    organization = models.ForeignKey('accounts.Organization', on_delete=models.CASCADE, related_name='savings_products', null=True, blank=True)
...
class SavingsAccount(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    organization = models.ForeignKey('accounts.Organization', on_delete=models.CASCADE, related_name='savings_accounts', null=True, blank=True)
