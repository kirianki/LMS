...
from .serializers import (
    BorrowerSerializer, BorrowerHistorySerializer,
    CustomerDocumentSerializer, FinancialStatementSerializer
)
...
class BorrowerViewSet(TenantScopedViewSet):
    ...
    def perform_create(self, serializer):
        ...
        if not instance.loan_officer:
             instance.loan_officer = self.request.user
        instance.save()
    ...
    def verify_id(self, request, pk=None):
        ...
        tenant_settings = request.user.organization
        ...
        # Automated Mode
        if not tenant_settings: # Assuming organization exists if verifying
...
class CustomerDocumentViewSet(TenantScopedViewSet):
    ...
    def perform_create(self, serializer):
        # Automatically assign organization via TenantScopedMixin
        super().perform_create(serializer)
        # Update uploaded_by field
...
class FinancialStatementViewSet(TenantScopedViewSet):
